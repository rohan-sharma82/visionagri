...
export const schemesData = [
    {
      ...
      imageUrl: 'https://dehaat-kheti-prod.s3.amazonaws.com/media/information_system/image/dehaat-kcc-kisan-credit-card-apply-online_f9f091f062.png',
      dataAiHint: 'kisan samman nidhi',
    },
    {
      id: 2,
    ...
    },
    {
      ...
      shortDescription: 'An initiative by the Government of Madhya Pradesh to provide financial assistance to farmers.',
      description: 'Mukhyamantri Kisan Kalyan Yojana has been started by the Government of Madhya Pradesh for all the poor farmers of MP. The objective of this important scheme is to improve the economic condition of the farmers and provide them sufficient amount for farming. Many times farmers need money to maintain farming, for which Kisan Kalyan Yojana has been started. Chief Minister Kisan Kalyan Yojana is to fulfill the concept of making agriculture a profitable business, to use advanced technology for agriculture, to fulfill the objective of increasing the income of farmers and to make the farmers of the state self-reliant. Benefits Farmers will be given Rs 4,000/- annually in two installments of Rs 2,000 each. Eligibility Applicants must be a permanent resident of Madhya Pradesh. Applicants must be a farmer. The applicant should be registered under PM Kisan Samman Nidhi Yojana. Applicant should have cultivable land in which they are doing farming. All Institutional Land holders along with other farmer families which belong to one or more of the following categories are not eligible. Former and present holders of constitutional posts Former and present Ministers/ State Ministers and former/present Members of LokSabha / RajyaSabha / State Legislative Assemblies/ State Legislative Councils, former and present Mayors of Municipal Corporations, former and present Chairpersons of District Panchayats. All serving or retired officers and employees of Central/ State Government Ministries /Offices/Departments and its field units Central or State PSEs and Attached offices /Autonomous Institutions under Government as well as regular employees of the Local Bodies (Excluding Multi Tasking Staff /Class IV/Group D employees) All superannuated/retired pensioners whose monthly pension is Rs. 10,000/-or more (Excluding Multi Tasking Staff / Class IV/Group D employees) of above category All Persons who paid Income Tax in last assessment year Professionals like Doctors, Engineers, Lawyers, Chartered Accountants, and Architects registered with Professional bodies and carrying out profession by undertaking practice. Applicant must be a poor farmers so that they can get financial assistance for farming. Application Process Online Applicants have to download the application form from theofficial websiteorfrom here, Applicants can also get the application form from the village Patwari office in their area. Fill out the application form. Attach the necessary documents Submit the application form and all the necessary documents to the Village Patwari. Village Patwari will get the application approved and applicants can receive the confirmed through the given mobile number and email id. Documents Required PM Kisan Samman Nidhi Registration No. Aadhar card. Documents related to agricultural land. One of the following documents for domicile:- Basic address proof. Voter ID Card. Electricity bill.',
    ...
    },
    {
      ...
      imageUrl: 'https://prakati.in/wp-content/uploads/2024/02/Kisan-Credit-Card-Scheme.webp',
    ...
    },
    {
      ...
      shortDescription: 'Provides farmers with a report on their soil\'s health and customized nutrient recommendations.',
      description: 'SHC can be downloaded by the farmers from the SHC portal or through SMS link received on mobile. It will contain the status of his soil with respect to 12 parameters, namely N,P,K, S (Macro-nutrients); Zn, Fe, Cu, Mn, Bo (Micro - nutrients) ; and pH, EC, OC. Based on this, the SHC will also indicate fertilizer recommendations and soil amendment required for the farm. ﻿ Component Rate Soil sampling, testing, and generation of SHC Rs 300 per SHC (Rs 40 for soil collection + Rs 150 for testing (analysing soil samples + cost of chemical) + Rs. 110 for awareness ﻿ The key objectives of the scheme are as follows: • To promote soil test based nutrient management across the country • To issue soil health cards to all farmers across the country • Strengthen the functioning of soil testing laboratories and associated infrastructure • Capacity building of district and state level staff for promotion of nutrient management practices • To diagnose soil fertility related constraints with standardized procedures for sampling uniformly across states; and analyse and design fertilizer recommendations. ﻿ Benefits The scheme targets to provide following benefits: Provide free / affordable access to soil test Provide farmers with timely and accurate soil analysis results Facilitate customized soil nutrient recommendations based on test results Enable farmers to optimize their fertiliser use and minimise input costs, and hence avoid under- or over- application of fertiliser ﻿ Eligibility The scheme is applicable for all farmers in India.',
