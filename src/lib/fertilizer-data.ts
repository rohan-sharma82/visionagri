...
export const fertilizerExplanations = [
    ...
    {
      name: "Zinc Sulphate",
      description: "A micronutrient fertilizer used to correct zinc deficiency in soils, which is a common issue in many agricultural areas. Zinc is crucial for enzyme function and plant growth."
    }
  ];
