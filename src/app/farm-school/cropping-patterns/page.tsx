    ...
    <>
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          <Card>
            <CardHeader>
                <CardTitle>What are Cropping Patterns?</CardTitle>
            </CardHeader>
          ...
          <Card>
             <CardHeader>
                <CardTitle>Types of Cropping Pattern in India</CardTitle>
            </CardHeader>
             <CardContent className="prose dark:prose-invert max-w-none">
                <ul>
          ...
          <Card>
            <CardHeader>
                <CardTitle>Factors Affecting Cropping Pattern in India</CardTitle>
